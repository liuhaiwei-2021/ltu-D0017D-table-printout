...
class Main {
  ...
  public static void main(String[] args) {
    ...
    final int SQUARE_ROOT_3 = 3;
    final int W2KW = 1000;

    // Declare constants for current (3 such values)
